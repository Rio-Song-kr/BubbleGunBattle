...
public class PlayerRotation : MonoBehaviour
{
    ...
    private void UpdateRotation()
    {
        ...
        //# Yaw 회전
        float turn = _rotateSpeed * _inputSmoothSpeed * _smoothedInput.x * Time.deltaTime * _player.Input.MouseSensitivity;
        ...
        //# Pitch 회전
        _currentPitch +=
            _smoothedInput.y * _pitchSpeed * (_pitchInverse ? 1 : -1) * Time.deltaTime * _player.Input.MouseSensitivity;
